package de.tudarmstadt.gdi1.project.analysis.caesar;
...
public class CaesarCryptanalysisImpl implements CaesarCryptanalysis {
	...
	public Integer knownCiphertextAttack(String ciphertext,
		...
		/**
		 * Berechnet die Standardabweichung der einzelnen Schlüssel.
		 * Der Schlüssel mit der kleinsten Standardabweichung, sollte mit der größten Wahrscheinlichkeit der richtige sein.
		 */
    ...
    public Integer knownPlaintextAttack(String ciphertext, String plaintext, Alphabet alphabet) {
    	...
    	if (ciphertext.length() == 0 || plaintext.length() == 0)
    		throw new IllegalArgumentException("Error: Plaintext and ciphertext don't have same size.");
